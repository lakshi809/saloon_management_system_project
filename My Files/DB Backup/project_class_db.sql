...
INSERT INTO `appointment` (`idappointment`, `date`, `status`, `created_at`, `updated_at`, `amount`, `master_user_idmaster_user`, `time_slot_idtime_slot`, `counsellor_id`, `category_id`) VALUES
...
INSERT INTO `category` (`id`, `category_name`, `amount`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `master_user` (`idmaster_user`, `first_name`, `last_name`, `contact_number`, `gender`, `dob`, `user_name`, `password`, `status`, `created_at`, `updated_at`, `role`) VALUES
...
ALTER TABLE `appointment`
  ...
  ADD KEY `fk_appointment_category1_idx` (`category_id`);
...
ALTER TABLE `master_user`
  ...
  ADD KEY `fk_master_useridx` (`role'iduser_role`);
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `fk_appointment_category1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `master_user`
  ADD CONSTRAINT `fk_master_user_user_role` FOREIGN KEY (`role'iduser_role`) REFERENCES `user_role` (`iduser_role`) ON DELETE NO ACTION ON UPDATE NO ACTION;
