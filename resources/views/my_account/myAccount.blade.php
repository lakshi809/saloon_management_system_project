...
<style>
    body, h1, h2, h3, h4, h5, h6, p, span, label, input, select, button {
...
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="col-lg-12">
            <div class="card m-b-20 custom-pink-card">
                <div class="card-body">

                    <div class="row">
                        <div class="col-lg-12" align="right">
                            <button class="btn w-md waves-effect waves-light" type="button"
                                    data-toggle="modal"  data-target="#changePasswordModal" style="background-color: #808080 !important; color: #000000 !important; border: 1px solid #707070;">
                                Change Password
                            </button>
                        </div>
                    </div>
                    ...
                    <h3 class="m-b-30 mt-0">{{$users->first_name}} {{$users->last_name}}</h3>
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="pass">First Name</label>
                                <input type="text" class="form-control" id="fName" autocomplete="off" name="fName" placeholder="First Name" readonly value="{{$users->first_name}}">
                                <input type="hidden" id="hiddenUserId" name="hiddenUserId" value="{{$users->id}}"/>
                                <small class="text-danger" id="fNameError"></small>
                            </div>
                            <div class="form-group">
                                <label for="pass">Last Name</label>
                                <input type="text" class="form-control" id="lName" autocomplete="off" name="lName" placeholder="Last Name" readonly value="{{$users->last_name}}">
                                <small class="text-danger" id="lNameError"></small>
                            </div>
                            <div class="form-group">
                                <label for="pass">Contact No</label>
                                <input type="number" class="form-control" id="contactNo" autocomplete="off" name="contactNo" placeholder="+(94) XX XXX XXXX" readonly   value="{{$users->contact_number}}">
                        ...
                        <div class="col-lg-4 text-right">
                            ...
                            <div style="margin-top: 60px;">
                                <button class="btn btn-primary w-md waves-effect waves-light mb-2" type="button" onclick="enablefield()">Edit Profile</button>
                                <br>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.errors != null) {
                    ...
                    if (data.errors.dob)
                        $('#dobError').html(data.errors.dob[0]);
